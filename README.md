...
| ![](https://techartaid.com/img/cheatsheet/mat-tex-banding.png)<br><br>**Banding in textures** | Stepped gradients in textures | Lossy compression can’t represent subtle gradient | - Use more contrast in your source textures (e.g. stronger normal map), then reduce it in shader |
