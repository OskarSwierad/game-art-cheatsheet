...
| ![](https://techartaid.com/img/cheatsheet/mat-white-edge.gif)<br>**Alpha bleeding** | White edges in textures with transparency | https://ciechanow.ski/alpha-compositing/ | - In Substance Painter, use `Dilation` mode when exporting<br> -In Photoshop, fill the background by selecting alpha mask, inverting selection and use Fill > Content Aware<br>- Respect premultiplied alpha in shaders |
